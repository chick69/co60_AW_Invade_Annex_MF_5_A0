null = ["0", getDir player, getPos player] execVM "script\bonus\Composition_table.sqf"

0 = [position user1, 0, call (compile (preprocessFileLineNumbers "script\bonus\Composition_table.sqf"))] call BIS_fnc_ObjectsMapper;
