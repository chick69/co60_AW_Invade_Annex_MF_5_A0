...
cl_Sqx_Markers_MarkerHelper_constructor = { private "_class_fields"; _class_fields = [["Sqx_Markers_MarkerHelper", []]]; _class_fields };





Sqx_Markers_MarkerHelper_PositionInsideAnyMarker = { 
    params ["_position", "_markers"];
...
Sqx_Markers_MarkerHelper_MarkerExists = { 
    params ["_markerName"];
...
Sqx_Markers_MarkerHelper_GetRandomPosInsideMarker = { 
    params ["_markerName"];
