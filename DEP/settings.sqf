...
// Military forces
// dep_u_soldier       = "O_G_Soldier_F";
// dep_u_gl            = "O_G_Soldier_GL_F";
// dep_u_ar            = "O_G_Soldier_AR_F";
// dep_u_at            = "O_G_Soldier_LAT_F";
// dep_u_medic         = "O_G_medic_F";
// dep_u_aa            = "O_G_engineer_F";
// dep_u_aaa           = "O_G_Soldier_exp_F";
// dep_u_sl            = "O_G_Soldier_SL_F";
// dep_u_marksman      = "O_G_Soldier_M_F";
// dep_u_sniper        = "O_G_officer_F";
