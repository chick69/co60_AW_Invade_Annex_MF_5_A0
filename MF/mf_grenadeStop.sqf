...
#define SAFETY_ZONES	[["respawn_west", 35]] // Syntax: [["marker1", radius1], ["marker2", radius2], ...]
#define MESSAGE "Placing / throwing items and firing at base is STRICTLY PROHIBITED!"
#define MESSAGEfr "Placer / jeter des charge ou tirer a la base est INTERDIT!"
